...
const Modal: FC<ModalProps> = ({onClose}) => {
    ...
    <div 
        ...
        >
            ...
            <div className="bg-card text-foreground p-6 md:p-8 rounded-2xl 
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-semibold mb-1 text-foreground">Description (Optional)</label>
                        <Textarea 
                ...
                <div className="flex space-x-4 mt-8">
                    <Button 
                        className="flex-1 bg-secondary text-secondary-foreground hover:bg-secondary/90 shadow-md"
                        onClick={onClose}
                    >
                        Cancel
                    </Button>
                    <Button 
                        className="flex-1 bg-primary text-primary-foreground hover:bg-primary/90 shadow-2xl shadow-primary/40"
                    >
